 ...
 * @property {boolean} clockwise - 게임进行方向：true为시계방향，false为逆时针。
 ...
 * @property {string} winner -  우승플레이어닉네임。
 * @property {string} min_cards -  우승플레이어수집된 카드 수。
 * @property {string} loser - 당기기플레이어닉네임。
 * @property {string} max_cards - 당기기플레이어수집된 카드 수。
 * @property {string} player_num - 플레이어수量。
 * @property {string} cardNum - 使用牌덱数。
 * @property {string} max_combo - 一次얻다最多的牌数。
 * @property {string} max_combo_player - 一次얻다最多的牌数的플레이어닉네임。
...
/**
 * @typedef {Poker[]} Pokers 扑克牌的配置,0~53序号。100+序号为변환牌，반송 카드没有변환牌。
 */
 ...
 * @property {GamePlayerSeatIndex?} seatIndex - 전송请求플레이어的좌석번호：0~7。play,discard,shiftOnline时不为空。
